...
class UtenteModel extends Utente{
  ...
  UtenteModel({required super.cognome, required super.dataNascita, required super.isAdmin, required super.nome, required super.telefono, required super.livello});
